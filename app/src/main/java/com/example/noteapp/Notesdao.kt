...
class Notesdao {
    ...
    fun AddNote(hd:HelperDatabase,note:String,note_title:String,emoji:String,note_date:String,note_color:String){
        val db  = hd.writableDatabase
    ...
    fun UpdateNote(hd:HelperDatabase,note_id:Int,note:String,note_title:String,emoji:String,note_date:String,note_color:String){
        val db  = hd.writableDatabase
        val values = ContentValues()
